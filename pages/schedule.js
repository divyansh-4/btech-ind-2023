...
import TitleCardS from "../components/common/TitleCardS";
            ...
            <>
              <div className="relative">
                ...
                <div className="flex justify-center items-center h-screen">
                  {/* You can customize the TitleCard for the schedule page */}
                  <TitleCardS
                    graphic1={
                      <Image
                    ...
                    title={
                      <span>
                        <span className="block text-5xl md:text-8xl">Btech Induction</span>
                        <span className="block text-9xl md:text-10xl">Schedule</span>
                        <span><br/></span>
                      </span>
                    }
                    subtext="AUGUST 2 - 6"
