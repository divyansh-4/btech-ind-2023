const TeamCards = ({ bg, teamName, teamMembers, memberImages, customImageStyle }) => {
    return (
      ...
      >
        <div className=" p-8">
          <div
            className={` w-full ${bg} text-center text-black text-3xl sm:text-xl md:text-2xl lg:text-3xl font-bold rounded-xl p-2 uppercase `}
            style={{
              backgroundImage: "url('/background_filters/teamCardBg.png') ",
            }}
          >
          ...
          <div
            className={` justify-center text-center w-full [h-30%] ${bg} rounded-xl flex flex-wrap mt-2 text-black text-base lg:text-lg sm:text-xs font-bold py-2 px-4 gap-x-1`}
            style={{
              backgroundImage: "url('/background_filters/teamCardBg.png') ",
            }}
          >
