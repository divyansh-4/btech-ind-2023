...
export default function WelcomeCard() {
  return (
    <div className="bg-[#252525] rounded md:p-[3rem] p-[2rem] max-w-[70%] xl:pr-[30%] relative">
      <div className="max-w-[100%] xl:max-w-[80%]">
        <div className="lg:text-[5rem] md:text-[4rem] sm:text-[3.5rem] text-[2.5rem] relative text-[#E44F44] font-bold leading-none w-fit">
          WELCOME<br></br>TO
      ...
      {/* <div className="h-0 w-0 flex items-center justify-center absolute right-0"></div> */}
