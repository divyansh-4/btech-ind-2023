  ...
  return (
    <div className='w-[87%] relative mx-auto'>
      <div className=' h-[35vh]    lg:h-[50vh] bg-neutral-800 rounded-[30px] relative z-20  pt-1 md:pt-3 lg:pt-4'>
        ...
        <div className='text-right text-amber-400 font-normal text-base leading-[3.5vh] md:text-lg lg:text-xl 2xl:text-3xl lg:leading-10 2xl:leading-[44px] absolute right-6 w-[45%] lg:w-[55%] mt-2 '>
          {desc}
      ...
      <div
        className={`w-full h-[35vh]   lg:h-[50vh] border-2 border-neutral-800 rounded-[30px] absolute top-6 left-6 ${color} z-10`}
      ></div>
    </div>
  );
}
